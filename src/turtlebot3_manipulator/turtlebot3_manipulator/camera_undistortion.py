...
class camera_undistortion:
    def __init__(self):
        ...
        self.dist = np.array([6.131983532253498098e-02,2.887928520306218272e-01,-7.355652692601365866e-03,-1.182111798112949440e-02,-1.211195517419898948e+00])
...
def main():
    ...
    undst_img = camera_undistortion.undistortion(img)
    cv2.imshow('', img)
    cv2.imshow('Undistorted Image', undst_img)
    cv2.waitKey(0)
